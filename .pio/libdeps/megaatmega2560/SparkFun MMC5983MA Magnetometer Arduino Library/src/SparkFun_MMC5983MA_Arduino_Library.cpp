...
void SFE_MMC5983MA::readInitialTemperature()
{
...
void SFE_MMC5983MA::readGaussMeasurement()
{
    ...
    currentX = getMeasurementX();
    currentY = getMeasurementY();
    currentZ = getMeasurementZ();

    // Uncomment if raw data wanted
